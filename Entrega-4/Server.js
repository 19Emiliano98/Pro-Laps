...
app.use('/static', express.static(__dirname + '/public'))   //  Static usado para mandar archivos cualesquiera  (html, css, img, etc...) - staticRoute se usa para asignarle un prefijo
